...
public class Staff extends JFrame {
    ...
    public Staff(HashMap<String, String> userData) {
    ...
    private void initComponents() {
        ...
        myAppointmentsItem.addActionListener(e -> openMyAppointmentsPage());
    ...
    private void openMyAppointmentsPage() {
